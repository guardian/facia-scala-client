...
import com.gu.facia.api.utils.{ContentProperties, Default => CardStyleDefault, FaciaContentUtils}
...
class FaciaContentHelperTest extends FreeSpec with Matchers {
  ...
  "should return 'Missing Headline' when the headline is None in a Snaps" in {
    val snap = LatestSnap("myId", CardStyleDefault, None, None, None, None, None, None, "myGroup", None, emptyContentProperties, None, None)
  ...
  "should return the headline for a CuratedContent" in {
    ...
    val cc = CuratedContent(content, Nil, CardStyleDefault, "The headline", None, None, "myGroup", None, emptyContentProperties, None, None, None, None, None)
  ...
  "should return a href for a LatestSnap" in {
    val snap = LatestSnap("myId", CardStyleDefault, None, None, None, None, Some("The href"), None, "myGroup", None, emptyContentProperties, None, None)
    FaciaContentUtils.href(snap) should equal(None)
  }

  "should return a byline for a LatestSnap" in {
    val content = Content("myId", None, None, None, "myTitle", "myUrl", "myApi", Some(Map("byline" -> "myByline")), Nil, None, Nil, None)
    val snap = LatestSnap("myId", CardStyleDefault, None, None, Some(content), None, Some("The href"), None, "myGroup", None, emptyContentProperties, None, None)
